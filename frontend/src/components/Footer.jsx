        ...
        <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-16">
          ...
          <div className="col-span-1 md:col-span-2 space-y-6">
            <div className="flex items-center gap-3">
              <div className="w-9 h-9 rounded-xl bg-white border border-line flex items-center justify-center">
          ...
          <div className="space-y-5">
            ...
            <ul className="space-y-3 text-sm text-bark-muted">
              <li><a href="#how-it-works" className="hover:text-clay-600 transition-colors">How it works</a></li>
              <li><a href="#features" className="hover:text-clay-600 transition-colors">Capabilities</a></li>
              <li><a href="#developer-sdk" className="hover:text-clay-600 transition-colors">Developer SDK</a></li>
            </ul>
          </div>
          ...
          <div className="space-y-5">
            ...
            <ul className="space-y-3 text-sm text-bark-muted">
              <li><a href="https://github.com/rohan911438/A2A-Protocol" target="_blank" rel="noreferrer" className="hover:text-clay-600 transition-colors">GitHub</a></li>
              <li><a href="#" className="hover:text-clay-600 transition-colors">X / Twitter</a></li>
              <li><a href="#" className="hover:text-clay-600 transition-colors">Discord</a></li>
            </ul>
          </div>

    ...
    <section id="features" className="py-36 px-6 relative overflow-hidden bg-black">
      ...
      <div className="max-w-7xl mx-auto z-10 relative space-y-24">
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-8">
          ...
          >
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-8 items-center h-full">
              <div className="space-y-6">
                <div className="w-12 h-12 rounded-xl bg-cyan-500/10 border border-cyan-500/20 flex items-center justify-center text-cyan-400 group-hover:scale-110 group-hover:border-cyan-400/40 transition-all duration-300">
              ...
              <div className="p-4 rounded-2xl bg-black/60 border border-zinc-900/80 h-[180px] flex flex-col justify-between relative overflow-hidden">
                <div className="flex justify-between items-center text-[9px] text-zinc-500 font-mono">
                  <span>SWARM PRICE RESOLUTION</span>
                  <span className="text-cyan-400">ROUND 4 CONVERGED</span>
                </div>
                
                <div className="flex-1 w-full relative mt-2">
                  <svg className="w-full h-full" viewBox="0 0 220 100" preserveAspectRatio="none">
                    {/* Grid lines */}
                    <line x1="10" y1="50" x2="210" y2="50" stroke="#18181b" strokeDasharray="3,3" />
                    <line x1="110" y1="10" x2="110" y2="90" stroke="#18181b" strokeDasharray="3,3" />
                    ...
                    {chartProgress > 95 && (
                      <circle cx="210" cy="50" r="3" fill="#22d3ee" />
                    )}
                  </svg>
                </div>
          ...
          >
            <div className="space-y-6">
              <div className="w-12 h-12 rounded-xl bg-purple-500/10 border border-purple-500/20 flex items-center justify-center text-purple-400 group-hover:scale-110 group-hover:border-purple-400/40 transition-all duration-300">
                <Lock size={20} />
              </div>
              <h3 className="text-xl font-bold uppercase tracking-tight text-white">
            ...
            <div 
              ...
              className="mt-8 p-4 rounded-2xl bg-black/60 border border-zinc-900/80 flex items-center justify-between cursor-pointer hover:border-zinc-800 transition-all"
            >
              <div className="flex items-center gap-3">
                <div className={`w-8 h-8 rounded-lg flex items-center justify-center transition-colors ${
                  escrowLocked ? 'bg-red-500/10 text-red-400 border border-red-500/20' : 'bg-green-500/10 text-green-400 border border-green-500/20'
                }`}>
                  <Key size={14} className={escrowLocked ? 'rotate-0' : 'rotate-45 transition-transform'} />
                </div>
                <div className="font-mono">
                  <div className="text-[10px] text-zinc-500 uppercase tracking-widest font-bold">Smart Contract State</div>
                  <div className="text-xs text-zinc-200 font-bold">{escrowLocked ? 'STATE_LOCKED_ESCROW' : 'STATE_RELEASED_SETTLED'}</div>
                </div>
              </div>
              <span className={`text-[8px] font-mono font-bold uppercase px-2.5 py-1 rounded-full border ${
                escrowLocked ? 'bg-red-500/5 border-red-500/30 text-red-400' : 'bg-green-500/5 border-green-500/30 text-green-400 animate-pulse'
              }`}>
          ...
          >
            ...
            <div 
              ...
              className="mt-8 p-4 rounded-2xl bg-black/60 border border-zinc-900/80 font-mono text-[10px] leading-relaxed relative overflow-hidden h-[110px]"
            >
              {!x402Success ? (
                <div className="space-y-1.5 text-zinc-500">
                  <div className="text-red-400 font-bold">HTTP/1.1 402 Payment Required</div>
                  <div>X-Agent-Gate: x402-gated-token</div>
                  <div>Status: <span className="text-red-400 font-bold">LOCKED_PAYLOAD</span></div>
                ...
                <div className="space-y-1.5 text-green-400 animate-fadeInUp">
                  <div className="font-bold">HTTP/1.1 200 OK [DECRYPTED]</div>
          ...
          >
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-8 items-center h-full">
              ...
              <div className="relative h-[150px] bg-black/60 rounded-2xl border border-zinc-900/80 flex items-center justify-center overflow-hidden">
                {/* Visual Mesh Lines */}
                <svg className="absolute inset-0 w-full h-full opacity-35" viewBox="0 0 200 120">
                  <line x1="40" y1="30" x2="160" y2="30" stroke="#27272a" strokeWidth="1" />
                  <line x1="40" y1="30" x2="40" y2="90" stroke="#27272a" strokeWidth="1" />
                  <line x1="160" y1="30" x2="160" y2="90" stroke="#27272a" strokeWidth="1" />
                  <line x1="40" y1="90" x2="160" y2="90" stroke="#27272a" strokeWidth="1" />
                  <line x1="40" y1="30" x2="160" y2="90" stroke="#27272a" strokeWidth="1" />
                  
                  {/* Glowing active node connection paths */}
                  {activeNode === 0 && <line x1="40" y1="30" x2="160" y2="30" stroke="#6366f1" strokeWidth="1.5" className="animate-pulse" />}
                  {activeNode === 1 && <line x1="160" y1="30" x2="160" y2="90" stroke="#a855f7" strokeWidth="1.5" className="animate-pulse" />}
                  {activeNode === 2 && <line x1="160" y1="90" x2="40" y2="90" stroke="#22d3ee" strokeWidth="1.5" className="animate-pulse" />}
                  {activeNode === 3 && <line x1="40" y1="90" x2="40" y2="30" stroke="#6366f1" strokeWidth="1.5" className="animate-pulse" />}
                </svg>
                ...
                <div className="absolute top-[20px] left-[30px] flex flex-col items-center">
                  <div className={`w-5 h-5 rounded-full flex items-center justify-center text-[8px] font-bold transition-all ${
                    activeNode === 0 ? 'bg-indigo-500 text-white shadow-[0_0_15px_#6366f1]' : 'bg-zinc-900 text-zinc-500 border border-zinc-800'
                  }`}>
                    B
                  </div>
                ...
                <div className="absolute top-[20px] right-[30px] flex flex-col items-center">
                  <div className={`w-5 h-5 rounded-full flex items-center justify-center text-[8px] font-bold transition-all ${
                    activeNode === 1 ? 'bg-purple-500 text-white shadow-[0_0_15px_#a855f7]' : 'bg-zinc-900 text-zinc-500 border border-zinc-800'
                  }`}>
                    S
                  </div>
                ...
                <div className="absolute bottom-[20px] right-[30px] flex flex-col items-center">
                  <div className={`w-5 h-5 rounded-full flex items-center justify-center text-[8px] font-bold transition-all ${
                    activeNode === 2 ? 'bg-cyan-500 text-white shadow-[0_0_15px_#22d3ee]' : 'bg-zinc-900 text-zinc-500 border border-zinc-800'
                  }`}>
                    V
                  </div>
                ...
                <div className="absolute bottom-[20px] left-[30px] flex flex-col items-center">
                  <div className={`w-5 h-5 rounded-full flex items-center justify-center text-[8px] font-bold transition-all ${
                    activeNode === 3 ? 'bg-indigo-500 text-white shadow-[0_0_15px_#6366f1]' : 'bg-zinc-900 text-zinc-500 border border-zinc-800'
                  }`}>
                    E
                  </div>
